          ...
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">456 New Avenue, Tech Park, 98765</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-800">contact@newdomain.com</p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-800">+1 (987) 654-3210</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full p-2 border rounded-md focus:ring-2 focus:ring-gray-500 focus:border-transparent"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full p-2 border rounded-md h-32 focus:ring-2 focus:ring-gray-500 focus:border-transparent"
                required
              ></textarea>
            </div>
